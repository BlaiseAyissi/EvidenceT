...
class KGEncoder(nn.Module):
    def __init__(self,
        ...
        hf_local_model = os.path.join("/home/cv/Blaise/EvidenceT/VQA/src/checkpoints/", "BiomedNLP-BiomedBERT-base-uncased-abstract")
        ...
        model_name = os.path.join("local-dir:/home/cv/Blaise/EvidenceT/VQA/src/checkpoints/", "BiomedCLIP-PubMedBERT_256-vit_base_patch16_224")
    ...
    def encode_text(self, text):
        ...
        #token_ids = text.to("cuda:0")
        # Debug output (remove after fixing)
        
        text_features = self.model.text(token_ids).to("cuda:0")
