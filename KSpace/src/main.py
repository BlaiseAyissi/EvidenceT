...
from dataload import UMLS_Dataset_SLAKE, UMLS_Dataset_SLAKE_test, UMLS_Dataset_PathVQA, UMLS_Dataset_PathVQA_test, UMLS_Dataset_VQARAD, UMLS_Dataset_VQARAD_test, UMLS_Dataset_Combine
...
def main():
    ...
    args.checkpoint_path = '/home/cv/Blaise/EvidenceT/KSpace/src/checkpoint'
    ...
    train_dataset = UMLS_Dataset_Combine(args, args.knowledge_graph_train, transform=train_transform)
    ...
    val_dataset  = UMLS_Dataset_Combine(args, args.knowledge_graph_test, transform=train_transform, test=True)
    ...
    tokenizer = open_clip.get_tokenizer(os.path.join(eval_path, 'BiomedCLIP-PubMedBERT_256-vit_base_patch16_224'))
